...
namespace Addaliil.Web.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(AdaliiDbContext context)
        {
            _context = context;
        }
        ...
        {
            var adaliiDbContext = _context.Products.Include(p => p.Category);
            return View(await adaliiDbContext.ToListAsync());
        }
